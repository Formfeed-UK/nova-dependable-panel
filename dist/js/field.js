...
/* harmony import */ var lodash_tap__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! lodash/tap */ "./node_modules/lodash/tap.js");
/* harmony import */ var lodash_tap__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(lodash_tap__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony import */ var lodash_forIn__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! lodash/forIn */ "./node_modules/lodash/forIn.js");
/* harmony import */ var lodash_forIn__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(lodash_forIn__WEBPACK_IMPORTED_MODULE_6__);
...
/* harmony import */ var lodash_identity__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! lodash/identity */ "./node_modules/lodash/identity.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  props: _objectSpread(_objectSpread({
    ...
    errors: {
      "default": function _default() {
        return new form_backend_validation__WEBPACK_IMPORTED_MODULE_1__.Errors();
      }
    },
    showHelpText: {
      type: Boolean,
  ...
  }, (0,laravel_nova__WEBPACK_IMPORTED_MODULE_0__.mapProps)(["mode"])), {}, {
    fields: {
      type: Array,
      "default": []
    },
  ...
  updated: function updated() {
    this.watchFields();
    this.setFieldValues();
    this.$emit(this.visible === true ? 'field-shown' : 'field-hidden', this.field.attribute);
  ...
  methods: {
    ...
    fill: function fill(formData) {
      if (this.visible) {
        for (var field in this.fieldInstances()) {
          try {
    ...
    watchErrors: function watchErrors() {
      var _this = this;

      this.$watch('errors', function (newErrors) {
        if (newErrors.errors) {
          Object.entries(newErrors.errors).forEach(function (error) {
            if (error[0] && _this.currentField.fields.find(function (x) {
              return x.attribute === error[0];
            })) {
              console.log(_this.tabSlug);
            }
          });
        }
      });
    },
    fieldInstances: function fieldInstances() {
      var fields = {};

      for (var field in this.$refs) {
        var _this$$refs$field;

        fields[field] = (_this$$refs$field = this.$refs[field]) === null || _this$$refs$field === void 0 ? void 0 : _this$$refs$field[0];
      }
    ...
    onSyncedField: function onSyncedField() {
      ...
      var _iterator = _createForOfIteratorHelper(this.currentField.fields),
          _step;

      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var field = _step.value;
          field.value = this.values.hasOwnProperty(field.attribute) && (!this.fieldInstances().hasOwnProperty(field.attribute) || !this.fieldInstances()[field.attribute]) ? this.values[field.attribute] : field.value;
        }
      } catch (err) {
        _iterator.e(err);
      } finally {
    ...
    initGroupedDependsOn: function initGroupedDependsOn() {
      var _this2 = this;
      ...
      if (!lodash_isEmpty__WEBPACK_IMPORTED_MODULE_9___default()(this.dependsOnGroups)) {
        var _loop = function _loop(dependsOn) {
          if (_this2.watchedEvents[dependsOn]) return "continue";

          _this2.watchedEvents[dependsOn] = function (value) {
            _this2.watchedFields[dependsOn] = value;

            _this2.dependentFieldDebouncer(function () {
              _this2.watchedFields[dependsOn] = value;
          ...
          Nova.$on(_this2.getFieldAttributeChangeEventName(dependsOn), _this2.watchedEvents[dependsOn]);
        };

        for (var dependsOn in this.dependsOnGroups) {
          var _ret = _loop(dependsOn);

          if (_ret === "continue") continue;
        }
      }
    },
    watchFields: function watchFields() {
      var _this3 = this;

      var _loop2 = function _loop2(field) {
        _this3.$watch(function () {
          var _this3$fieldInstances;

          return (_this3$fieldInstances = _this3.fieldInstances()[field]) === null || _this3$fieldInstances === void 0 ? void 0 : _this3$fieldInstances.value;
        }, function (value) {
          _this3.values[field] = value;
        });
      };
    ...
    watchKeys: function watchKeys() {
      ...
      this.$watch(function () {
        return _this4.currentField.validationKey;
      }, function (value) {
        if (_this4.syncedField) _this4.syncedField.validationKey = _this4.field.validationKey;
      });
      this.$watch(function () {
        return _this4.currentField.uniqueKey;
      }, function (value) {
        if (_this4.syncedField) _this4.syncedField.uniqueKey = _this4.field.uniqueKey;
      });
    },
    setFieldValues: function setFieldValues() {
      ...
      var _iterator2 = _createForOfIteratorHelper(this.syncedField.fields),
          _step2;

      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          var field = _step2.value;
          var currField = this.fieldInstances()[field.attribute];

          if (!lodash_isNil__WEBPACK_IMPORTED_MODULE_10___default()(field.value)) {
    ...
    setFieldDependentGroup: function setFieldDependentGroup(field) {
      if (!this.currentField.singleRequest) {
        return;
      }

      field.dependsOnGroups = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_12___default()(field.dependsOn);
      field.dependsOn = null;
    }
  },
  computed: {
    currentFields: function currentFields() {
      var _this5 = this;

      var fields = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_12___default()(this.currentField.fields);
      var instances = this.fieldInstances();
      fields.forEach(function (field) {
        field.panel = _this5.panel;
        field.dependentComponentKey = "dependent_panel.".concat(_this5.currentField.attribute, ".").concat(field.dependentComponentKey);

        if (_this5.isInFlexibleGroup) {
          field.validationKey = "".concat(_this5.groupKey, "__").concat(field.validationKey);
          field.uniqueKey = "".concat(_this5.groupKey, "-").concat(field.uniqueKey);
        }

        _this5.setFieldDependentGroup(field);
    ...
    dependsOnGroups: function dependsOnGroups() {
      var _this6 = this;

      var groupedDependsOn = {};
      lodash_each__WEBPACK_IMPORTED_MODULE_2___default()(this.currentFields, function (field) {
        if (field.dependsOnGroups) {
          lodash_each__WEBPACK_IMPORTED_MODULE_2___default()(field.dependsOnGroups, function (defaultValue, dependsOn) {
            if (!groupedDependsOn[dependsOn]) {
              groupedDependsOn[dependsOn] = [];
            }

            groupedDependsOn[dependsOn].push(field.attribute);
            _this6.watchedFields[dependsOn] = defaultValue;
          });
        }
      });
      return groupedDependsOn;
    },
    currentInstances: function currentInstances() {
    ...
    uniquePrefix: function uniquePrefix() {
      var split = this.currentField.uniqueKey.split("-");
    ...
    isInFlexibleGroup: function isInFlexibleGroup() {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return $options.visible ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_1, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.currentFields, function (field, index) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)((0,vue__WEBPACK_IMPORTED_MODULE_0__.resolveDynamicComponent)("form-".concat(field.component)), {
      ...
      mode: _ctx.mode,
      onFieldShown: _ctx.handleFieldShown,
      onFieldHidden: _ctx.handleFieldHidden,
      onFieldChanged: _cache[0] || (_cache[0] = function ($event) {
        return _ctx.$emit('field-changed');
      }),
      onFileDeleted: _cache[1] || (_cache[1] = function ($event) {
        return _ctx.$emit('update-last-retrieved-at-timestamp');
      }),
      onFileUploadStarted: _cache[2] || (_cache[2] = function ($event) {
        return _ctx.$emit('file-upload-started');
      }),
      onFileUploadFinished: _cache[3] || (_cache[3] = function ($event) {
        return _ctx.$emit('file-upload-finished');
      }),
      "show-help-text": $props.showHelpText
    }, null, 40
    /* PROPS, HYDRATE_EVENTS */
    , ["index", "errors", "resource-id", "resource-name", "related-resource-name", "related-resource-id", "field", "via-resource", "via-resource-id", "via-relationship", "shown-via-new-relation-modal", "form-unique-id", "mode", "onFieldShown", "onFieldHidden", "show-help-text"]);
  }), 128
  /* KEYED_FRAGMENT */
...
Nova.booting(function (app, store) {
  app.component('index-nova-dependable-panel', _components_IndexField__WEBPACK_IMPORTED_MODULE_0__["default"]);
  app.component('detail-nova-dependable-panel', _components_DetailField__WEBPACK_IMPORTED_MODULE_1__["default"]);
  app.component('form-nova-dependable-panel', _components_FormField__WEBPACK_IMPORTED_MODULE_2__["default"]);
});
...
/* harmony import */ var _var_www_nova4_formfeed_co_uk_nova_components_DependablePanel_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");




;
const __exports__ = /*#__PURE__*/(0,_var_www_nova4_formfeed_co_uk_nova_components_DependablePanel_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_DetailField_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_DetailField_vue_vue_type_template_id_0224618e__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/components/DetailField.vue"]])
/* hot reload */
if (false) {}
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkformfeed_nova_dependable_panel"] = self["webpackChunkformfeed_nova_dependable_panel"] || [];
