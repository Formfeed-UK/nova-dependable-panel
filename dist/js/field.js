...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  updated: function updated() {
    this.watchFields(); //this.setFieldValues();
  ...
  methods: {
    ...
    initialFieldVisibility: function initialFieldVisibility() {
      var _this = this;

      lodash_each__WEBPACK_IMPORTED_MODULE_2___default()(this.currentField.fields, function (field) {
    ...
    removeEventWatchers: function removeEventWatchers() {
      var _this2 = this;

      if (!lodash_isEmpty__WEBPACK_IMPORTED_MODULE_3___default()(this.watchedEvents)) {
        lodash_forIn__WEBPACK_IMPORTED_MODULE_6___default()(this.watchedEvents, function (event, dependsOn) {
    ...
    onSyncedField: function onSyncedField() {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          if (this.fieldInstances().hasOwnProperty(field.attribute) && !lodash_isNil__WEBPACK_IMPORTED_MODULE_4___default()(this.fieldInstances()[field.attribute])) {
            var _ref, _this$values$field$at;

            var instance = this.fieldInstances()[field.attribute];
            field.value = lodash_isNil__WEBPACK_IMPORTED_MODULE_4___default()(field.value) ? (_ref = (_this$values$field$at = this.values[field.attribute]) !== null && _this$values$field$at !== void 0 ? _this$values$field$at : field.defaultValue) !== null && _ref !== void 0 ? _ref : instance.currentField.value : field.value;
            instance.syncedField = field;
            instance.setInitialValue();
          } else {
            var _ref2, _ref3, _this$values$field$at2;

            field.value = lodash_isNil__WEBPACK_IMPORTED_MODULE_4___default()(field.value) ? (_ref2 = (_ref3 = (_this$values$field$at2 = this.values[field.attribute]) !== null && _this$values$field$at2 !== void 0 ? _this$values$field$at2 : field.defaultValue) !== null && _ref3 !== void 0 ? _ref3 : field.value) !== null && _ref2 !== void 0 ? _ref2 : null : field.value;
          }
        }
      } catch (err) {
        _iterator.e(err);
    ...
    initGroupedDependsOn: function initGroupedDependsOn() {
      ...
      if (!lodash_isEmpty__WEBPACK_IMPORTED_MODULE_3___default()(this.dependsOnGroups)) {
        var _loop = function _loop(dependsOn) {
          if (_this3.watchedEvents[dependsOn]) return "continue";

          _this3.watchedEvents[dependsOn] = function (value) {
            _this3.watchedFields[dependsOn] = value;

            _this3.dependentFieldDebouncer(function () {
              _this3.watchedFields["_changedField"] = dependsOn;
              _this3.watchedFields[dependsOn] = value;
          ...
          Nova.$on(_this3.getFieldAttributeChangeEventName(dependsOn), _this3.watchedEvents[dependsOn]);
        };
    ...
    watchFields: function watchFields() {
      ...
      var _loop2 = function _loop2(field) {
        _this4.$watch(function () {
          var _this4$fieldInstances;

          return (_this4$fieldInstances = _this4.fieldInstances()[field]) === null || _this4$fieldInstances === void 0 ? void 0 : _this4$fieldInstances.value;
        }, function (value) {
          _this4.values[field] = value;
        });
      };
    ...
    watchKeys: function watchKeys() {
      ...
      this.$watch(function () {
        return _this5.currentField.validationKey;
      }, function (value) {
        if (_this5.syncedField) _this5.syncedField.validationKey = _this5.field.validationKey;
      });
      this.$watch(function () {
        return _this5.currentField.uniqueKey;
      }, function (value) {
        if (_this5.syncedField) _this5.syncedField.uniqueKey = _this5.field.uniqueKey;
      });
    },
    setFieldValues: function setFieldValues() {
      var _iterator2 = _createForOfIteratorHelper(this.currentField.fields),
          _step2;
      ...
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          ...
          if (lodash_isNil__WEBPACK_IMPORTED_MODULE_4___default()(field.value) && !lodash_isNil__WEBPACK_IMPORTED_MODULE_4___default()(field.defaultValue)) {
            field.value = field.defaultValue;
          }

          if (!lodash_isNil__WEBPACK_IMPORTED_MODULE_4___default()(field.value)) {
            this.values[field.attribute] = field.value;

            if (!lodash_isNil__WEBPACK_IMPORTED_MODULE_4___default()(currField)) {
    ...
    setFieldDependentGroup: function setFieldDependentGroup(field) {
      ...
      field.dependsOnGroups = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_5___default()(field.dependsOn);
  ...
  computed: {
    currentFields: function currentFields() {
      ...
      var fields = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_5___default()(this.currentField.fields);
      var instances = this.fieldInstances();
      fields.forEach(function (field) {
        field.panel = _this6.panel;
        field.dependentComponentKey = "dependent_panel.".concat(_this6.currentField.attribute, ".").concat(field.dependentComponentKey);

        if (_this6.isInFlexibleGroup) {
          field.validationKey = "".concat(_this6.groupKey, "__").concat(field.validationKey);
          field.uniqueKey = "".concat(_this6.groupKey, "-").concat(field.uniqueKey);
        }

        _this6.setFieldDependentGroup(field);
      });
      return fields;
    },
    syncedFields: function syncedFields() {},
    initialFields: function initialFields() {},
      ...
      lodash_each__WEBPACK_IMPORTED_MODULE_2___default()(this.currentFields, function (field) {
        if (field.dependsOnGroups) {
          lodash_each__WEBPACK_IMPORTED_MODULE_2___default()(field.dependsOnGroups, function (defaultValue, dependsOn) {
            ...
            if (!lodash_isNil__WEBPACK_IMPORTED_MODULE_4___default()(defaultValue)) _this7.watchedFields[dependsOn] = defaultValue;
          });
        }
      });
    ...
    visibleFieldsCount: function visibleFieldsCount() {
      return Object.values(this.visibleFieldsForPanel).filter(function (visible) {
        return visible;
      }).length;
    },
    visible: function visible() {
      var isVisible = !(!this.currentField.visible || this.visibleFieldsCount === 0 || this.currentFields.length === 0);
      this.$emit(isVisible === true ? 'field-shown' : 'field-hidden', this.field.attribute);
      return isVisible;
    },
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_1, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($props.field.fields, function (field, index) {
    ...
    , ["index", "resource-name", "resource-id", "resource", "field", "onActionExecuted"]);
  }), 128
  /* KEYED_FRAGMENT */
  ))]);
}
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)(((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_1, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.currentFields, function (field, index) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)((0,vue__WEBPACK_IMPORTED_MODULE_0__.resolveDynamicComponent)("form-".concat(field.component)), {
      ...
      mode: _ctx.mode,
      onFieldShown: $options.handleFieldShown,
      onFieldHidden: $options.handleFieldHidden,
  ...
  /* NEED_PATCH */
  )), [[vue__WEBPACK_IMPORTED_MODULE_0__.vShow, $options.visible]]);
}
...
/* harmony import */ var _workspace_submodules_nova_dependable_panel_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");




;
const __exports__ = /*#__PURE__*/(0,_workspace_submodules_nova_dependable_panel_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_DetailField_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_DetailField_vue_vue_type_template_id_0224618e__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/components/DetailField.vue"]])
/* hot reload */
if (false) {}
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkformfeed_uk_nova_dependable_panel"] = self["webpackChunkformfeed_uk_nova_dependable_panel"] || [];
